...
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS11_yulara_diagnostic.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS12_alpha_sensitivity.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS10_qcells_support.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS2_common_origins.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS4_fixed_leads.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/fig4_neural_gaps.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS1_alice_ranks.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS3_latency.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS5_block_intervals.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS6_monthly.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS7_cases_fixed.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS7_cases_extremes.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS8_ridge.pdf}
...
\end{figure}
\clearpage\begin{figure}[p]\centering
\includegraphics[width=0.98\textwidth,height=0.86\textheight,keepaspectratio]{closeout_figures/figS9_learning_budget.pdf}
...
\includegraphics[width=0.96\textwidth]{closeout_figures/fig7_qcells_selection.pdf}
\caption{Qcells Test: 6463 one-hour origins become 2996 complete-twelve-hour origins. Exclusive attribution assigns 3350 removals to future negative labels and 117 to the tail boundary. Active one-hour pairs decrease from 36504 to 42, involving 25 unique active timestamps and 25 origins.}\par\small\textit{Alt text: The frozen negative-label rule and continuous-window requirement select a strongly different hourly and power distribution; complete-window support is not inherently representative.}\end{figure}

\clearpage
\begin{figure}[p]\centering
\includegraphics[width=0.96\textwidth]{closeout_figures/fig2_alice_references.pdf}
\caption{Post hoc minimum three-seed mean neural RMSE relative to both references on the same Daily-valid targets. F: full; A: power-active. The envelope is descriptive, not deployable.}\par\small\textit{Alt text: Twenty-four Alice comparisons on shared logarithmic axes: both references use the Daily intersection. Ratio one is the comparison boundary; unfavorable ratios remain visible.}\end{figure}

\clearpage
\begin{figure}[p]\centering
\includegraphics[width=0.96\textwidth]{closeout_figures/fig3_external_skills.pdf}
\caption{Inverted-variate mean seed skill with 95\% paired temporal-block intervals: 48 h blocks, 2000 resamples. These are conditional time-sample intervals, not seed SD. Each reference has its own matched targets.}\par\small\textit{Alt text: Full and power-active effects include intervals crossing zero at long windows; small training-seed SD does not replace temporal uncertainty.}\end{figure}
